...
export default function EditEventView(props) {
    const { handleChangeField, handleSubmit, handleChangeFieldValue, eventValues, eventInfo } = props;
    const [showAlert, setShowAlert] = React.useState(false);
    const [eventStatus, setEventStatus] = React.useState(false);
    const [dateStart, setDateStart] = React.useState(eventValues.startDate);
    const [dateEnd, setDateEnd] = React.useState(eventValues.endDate);
